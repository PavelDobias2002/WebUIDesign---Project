...
<div class="movie-container">
	<div class="image">
		<img src='{base}/Mickey_17.jpg' alt="Mickey 17 movie poster">
	</div>
	<div class="title">
		<h3>Mickey 17</h3>
	</div>
	...
	<div class="trailer">
		<h3>trailer</h3>
		<iframe src="{base}https://www.youtube.com/embed/osYpGSz_0i4?si=raKvz4ESw3Wj_jml"
			title="Mickey 17 trailer"
			frameborder="0" 
...
.trailer iframe {
	...
	@media (max-width: 768px) {
		...
		.movie-container > div{
			...
			box-shadow: none;
			border-bottom: 4px solid rgb(47, 50, 78);
		}
 		.image{
 			grid-area: 2 / 1 / 3 / 2;
 		}
